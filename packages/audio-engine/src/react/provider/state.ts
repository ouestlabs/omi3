import { type IAudioEngine, type Music, PlaybackState } from "../../types";
...
const initialError: { code?: number; message?: string } | null = null;
const initialCurrentMusic: Music | null = null;
const initialFrequencyData: Uint8Array | null = null;
const initialAnalyserNode: AnalyserNode | null = null;
