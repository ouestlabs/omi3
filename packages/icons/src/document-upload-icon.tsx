   ...
   aria-hidden="true" role="img">
    <g>
      <path
        ...
        opacity={0.4}
      />
      <path d="M15.8 2.21c-.41-.41-1.12-.13-1.12.44v3.49c0 1.46 1.24 2.67 2.75 2.67.95.01 2.27.01 3.4.01.57 0 .87-.67.47-1.07-1.44-1.45-4.02-4.06-5.5-5.54M11.53 12.47l-2-2c-.01-.01-.02-.01-.02-.02a.9.9 0 0 0-.22-.15h-.02c-.08-.03-.16-.04-.24-.05h-.08a.65.65 0 0 0-.26.07c-.08.04-.16.08-.22.15l-2 2c-.29.29-.29.77 0 1.06s.77.29 1.06 0l.72-.72V17c0 .41.34.75.75.75s.75-.34.75-.75v-4.19l.72.72c.15.15.34.22.53.22s.38-.07.53-.22c.29-.29.29-.77 0-1.06" />
    </g>
    <defs>
      <clipPath>
