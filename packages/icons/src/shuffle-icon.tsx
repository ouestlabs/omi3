...
const ShuffleIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
   ...
   aria-hidden="true" role="img">
    <g>
      <path
        d="M21.75 17.98c0-.02-.01-.04-.01-.06-.01-.08-.02-.16-.05-.23a1 1 0 0 0-.15-.23s0-.01-.01-.01a.78.78 0 0 0-.53-.22l-4.67.02h-.01c-.6 0-1.18-.28-1.54-.76l-1.22-1.57a.74.74 0 0 0-1.05-.13.74.74 0 0 0-.13 1.05l1.22 1.57c.65.84 1.67 1.34 2.73 1.34h.01l2.85-.01-.71.71c-.29.29-.29.77 0 1.06.15.15.34.22.53.22s.38-.07.53-.22l2-2c.07-.07.12-.15.16-.24.03-.1.05-.2.05-.29M8.42 6.69a3.45 3.45 0 0 0-2.8-1.43H5.6l-2.61.01c-.41 0-.75.34-.75.75s.34.75.75.75l2.61-.01h.01c.63 0 1.22.3 1.58.81l1.08 1.5c.15.2.38.31.61.31.15 0 .31-.05.44-.14.34-.24.41-.71.17-1.05z"
        opacity={0.4}
      />
