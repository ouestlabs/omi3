...
<TabsList>
  ...
  <TabsTrigger value="copy">Code</TabsTrigger>
</TabsList>
...
<ComponentSource name="provider" title="components/ui/audio/provider.tsx" />
...
```tsx
import { AudioPlayer, AudioPlayerControlBar, AudioPlayerPlay } from "@/components/ui/audio/player"
