---
title: Introduction
description: A modern audio UI component library built on top of shadcn/ui.
---
...
_In a typical library, if you need to change a button's behavior, you have to override styles or wrap the component. With audio/ui, you simply edit the button code directly._
