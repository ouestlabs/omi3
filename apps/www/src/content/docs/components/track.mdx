...
<Callout variant="info">
  ...
  - **AudioProvider Requirement:** <code>AudioProvider</code> (or the project's audio store) is required for store mode to work correctly. Make sure to wrap your app with the provider at the root level.
